        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid px-4">
                    <div class="row g-3 my-2">
                        <div class="col-md-3">
                            <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                                <div>
                                    <h3 class="fs-2"><?php $sql = "SELECT id FROM cart WHERE cart = 'Yes';";
                                                        $result = mysqli_query($conn, $sql);
                                                        $dataID = mysqli_fetch_all($result, MYSQLI_ASSOC);
                                                        if (!($dataID)) {
                                                            $count = 0;
                                                        } else {
                                                            $data[] = array();
                                                            for ($i = 0; $i < count($dataID);) {
                                                                $data[$i] = $dataID[$i]['id'];
                                                                $i++;
                                                            }
                                                        }
                    ...
                    <div class="row my-5">
                        <h3 class="fs-4 mb-3">Checkout</h3>
                        <div class="col">
                            <table class="table bg-white rounded shadow-sm  table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $sql = "SELECT count(product_id) as total, id FROM cart WHERE cart = 'Yes' GROUP BY id;";
                                    $result = mysqli_query($conn, $sql);
                                    if (!$result) {
                                        echo "NULL";
                                    } else {
