                                ...
                                <tr>
                                    <th scope="col">
                                        <form action="upload_proses.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <input type="text" class="form-control" placeholder="Item ID" name="id">
                                                </div>
                                                <div class="col">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <label for="formGroupExampleInput">Image Product</label>
                                                    <div class="form-group">
                                                        <input id="input-b1" name="my_image1" type="file" class="file" data-browse-on-zone-click="true">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <label for="formGroupExampleInput">Image Cart</label>
                                                    <div class="form-group">
